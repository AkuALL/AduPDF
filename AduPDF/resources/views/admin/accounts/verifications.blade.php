...
<div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
    ...
    <div class="p-6 border-b border-slate-200 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-xl font-bold text-slate-800">Antrian Verifikasi Akun Pengguna (US-15 / FR-17)</h1>
            <p class="text-xs text-slate-500 mt-1">
                Kelola pendaftaran mandiri mahasiswa, dosen, dan staf kampus. Akun hanya dapat masuk setelah disetujui.
            </p>
        </div>
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center text-slate-500 text-sm">
                            <div class="max-w-xs mx-auto">
                                ...
                                <p class="text-xs text-slate-400 mt-1">Saat ada pendaftaran baru, akun akan muncul pada tab Menunggu Verifikasi.</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
